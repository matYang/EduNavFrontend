        ...
        <div class="clearfix">
            <div id="bookingSearchPanel">
                ...
                <div id="queryBooking" class="fleft search hidden">
                    ...
                    <input id="startBookingStatusAdjustTime_Input" class="date" type="text" placeholder="状态调整时间开始"/>
                    <input id="finishBookingStatusAdjustTime_Input" class="date" type="text" placeholder="状态调整时间结束"/>
                    <input id="startServiceFeeStatusAdjustTime_Input" class="date" type="text" placeholder="服务费状态调整时间开始"/>
                    <input id="finishServiceFeeStatusAdjustTime_Input" class="date" type="text" placeholder="服务费状态调整时间结束"/>
                    <input id="startCommissionStatusAdjustTime_Input" class="date" type="text" placeholder="佣金调整时间开始"/>
                    <input id="finishCommissionStatusAdjustTime_Input" class="date" type="text" placeholder="佣金调整时间结束"/>
                    <input id="startNoRefundDate_Input" class="date" type="text" placeholder="无退款时间开始"/>
                    <input id="finishNoRefundDate_Input" class="date" type="text" placeholder="无退款时间结束"/>
                    <input id="startCashbackDate_Input" class="date" type="text" placeholder="返金时间开始"/>
                    <input id="finishCashbackDate_Input" class="date" type="text" placeholder="返金时间结束"/>
                    <div>
                        <label>订单类型</label>
                        <select id="bookingType_Input">
                    ...
                    <div>
                        <label>服务费状态</label>
                        <select id="serviceFeeStatus_Input">
                            <option value=0>应收服务费</option>
                            <option value=1>已收服务费</option>
                            <option value=2>退换服务费</option>
                            <option value=3>无服务费</option>
                            <option value=4>服务费完结</option>
                            <option value=5>空</option>
                        </select>
                    </div>
                    <div>
                        <label>佣金状态</label>
                        <select id="commissionStatus_Input">
                            <option value=0>应收佣金</option>
                            <option value=1>已收佣金</option>
                            <option value=2>退还佣金</option>
                            <option value=3>无佣金</option>
                            <option value=4>佣金完结</option>
                            <option value=5>空</option>
                        </select>
                    </div>
                    <div>
                        <label>前服务费状态</label>
                        <select id="preServiceFeeStatus_Input">
                            <option value=0>应收服务费</option>
                            <option value=1>已收服务费</option>
                            <option value=2>退换服务费</option>
                            <option value=3>无服务费</option>
                    ...
                    <div>
                        <label>前佣金状态</label>
                        <select id="preCommissionStatus_Input">
                            <option value=0>应收佣金</option>
                            <option value=1>已收佣金</option>
                            <option value=2>退还佣金</option>
                            <option value=3>无佣金</option>
