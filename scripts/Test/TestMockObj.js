testMockObj = {
    ...
    testCourse1: (new Course()).set("courseId",1).set("courseName", "雅思英语").set("price",10800).set("instName","南京新东方").set("location", "南京市玄武区").set("cashback", 0),
    testCourse2: (new Course()).set("courseId",2).set("courseName", "SAT").set("price",10800).set("instName","School A").set("location", "南京市白下区").set("cashback", 50),
    testCourse3: (new Course()).set("courseId",3).set("courseName", "托福").set("price",9800).set("instName","School B").set("location", "南京市秦淮区").set("cashback", 12),
