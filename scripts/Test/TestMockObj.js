...
testMockObj = {
    ...
    testCourse1: (new Course()).set("partnerIntro", longText).set("id", 1).set("courseName", "雅思英语").set("price", 10800).set("instName", "南京新东方").set("address", "南京市玄武区").set("cashback", 0).set("status",  EnumConfig.CourseStatus.openEnroll),
    testCourse2: (new Course()).set("partnerIntro", longText).set("id", 2).set("courseName", "SAT").set("price", 10800).set("instName", "School A").set("address", "南京市白下区").set("cashback", 50).set("status",  EnumConfig.CourseStatus.openEnroll),
    testCourse3: (new Course()).set("partnerIntro", longText).set("id", 3).set("courseName", "托福").set("price", 9800).set("instName", "School B").set("address", "南京市秦淮区").set("cashback", 12).set("status",  EnumConfig.CourseStatus.openEnroll),
    testCourse4: (new Course()).set("id", 4).set("courseName", "GRE").set("price",12900).set("instName", "School C").set("address", "南京市建邺区").set("status",  EnumConfig.CourseStatus.openEnroll),
    testCourse5: (new Course()).set("id", 5).set("courseName", "四六级").set("price",5800).set("instName", "School D").set("address", "南京市鼓楼区").set("cashback", 10).set("status",  EnumConfig.CourseStatus.openEnroll),
    testCourse6: (new Course()).set("id", 6).set("courseName", "雅思英语").set("price",9800).set("instName", "School E").set("address", "南京市下关区").set("status",  EnumConfig.CourseStatus.openEnroll),
    testCourse7: (new Course()).set("id", 7).set("courseName", "小学英语补习").set("price",4000).set("instName", "School F").set("address", "南京市浦口区").set("status",  EnumConfig.CourseStatus.openEnroll),
