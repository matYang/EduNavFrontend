...
testMockObj = {
    ...
    testPhoto1: (new Photo()).set("classPhotoId", 1).set("imgUrl", "/testUrl1"),
    testPhoto2: new Photo().set("classPhotoId", 2).set("imgUrl", "/testUrl2"),
    testPhoto3: new Photo().set("classPhotoId", 3).set("imgUrl", "/testUrl3"),
    testPhoto4: new Photo().set("classPhotoId", 4).set("imgUrl", "/testUrl4"),
    testPhoto5: new Photo().set("classPhotoId", 5).set("imgUrl", "/testUrl5"),
    testPhoto6: new Photo().set("classPhotoId", 6).set("imgUrl", "/testUrl6"),

    testCourses: new Courses(),
    testCourse1: (new Course()).set("partnerIntro", longText).set("courseId", 1).set("courseName", "雅思英语").set("price", 10800).set("instName", "南京新东方").set("location", "南京市玄武区").set("cashback", 0).set("status",  EnumConfig.CourseStatus.openEnroll),
    testCourse2: (new Course()).set("partnerIntro", longText).set("courseId", 2).set("courseName", "SAT").set("price", 10800).set("instName", "School A").set("location", "南京市白下区").set("cashback", 50).set("status",  EnumConfig.CourseStatus.openEnroll),
    testCourse3: (new Course()).set("partnerIntro", longText).set("courseId", 3).set("courseName", "托福").set("price", 9800).set("instName", "School B").set("location", "南京市秦淮区").set("cashback", 12).set("status",  EnumConfig.CourseStatus.openEnroll),
    testCourse4: (new Course()).set("courseId", 4).set("courseName", "GRE").set("price",12900).set("instName", "School C").set("location", "南京市建邺区").set("status",  EnumConfig.CourseStatus.openEnroll),
    testCourse5: (new Course()).set("courseId", 5).set("courseName", "四六级").set("price",5800).set("instName", "School D").set("location", "南京市鼓楼区").set("cashback", 10).set("status",  EnumConfig.CourseStatus.openEnroll),
    testCourse6: (new Course()).set("courseId", 6).set("courseName", "雅思英语").set("price",9800).set("instName", "School E").set("location", "南京市下关区").set("status",  EnumConfig.CourseStatus.openEnroll),
    testCourse7: (new Course()).set("courseId", 7).set("courseName", "小学英语补习").set("price",4000).set("instName", "School F").set("location", "南京市浦口区").set("status",  EnumConfig.CourseStatus.openEnroll),
    testCourse8: (new Course()).set("courseId", 8).set("courseName", "初中英语").set("price",10800).set("instName", "School G").set("cashback", 50).set("status",  EnumConfig.CourseStatus.openEnroll),
    testCourse9: (new Course()).set("courseId", 9).set("courseName", "商务英语").set("price",9800).set("instName", "School H").set("status",  EnumConfig.CourseStatus.openEnroll),
    testCourse10: (new Course()).set("courseId", 10).set("courseName", "OMG英语").set("price",12900).set("instName", "School I").set("status",  EnumConfig.CourseStatus.openEnroll),
    testCourse11: (new Course()).set("courseId", 11).set("courseName", "口语强化班").set("price",5800).set("instName", "School J").set("cashback", 100).set("status",  EnumConfig.CourseStatus.openEnroll),
    testCourse12: (new Course()).set("courseId", 12).set("courseName", "高考图集").set("price",9800).set("instName", "School K").set("status",  EnumConfig.CourseStatus.openEnroll),
