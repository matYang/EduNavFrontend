...
testMockObj = {
    ...
    testCourse1: (new Course()).set("categoryValue","000101").set("partnerIntro", longText).set("id", 1).set("courseName", "雅思英语").set("price", 10800).set("instName", "南京新东方").set("address", "南京市玄武区").set("cashback", 10).set("commission", 20).set("status",  EnumConfig.CourseStatus.onlined).set("bookingType",  2).set('startUponArrival',1).set('startDate',new Date()),
