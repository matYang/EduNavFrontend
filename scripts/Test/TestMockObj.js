...
testMockObj = {
    ...
    testBooking1: (new Booking()).set("id", 1).set("reference", "10001").set("status", 0).set("type", 1).set("name", "马修").set("phone", 13915063907).set("email", "test@gmail.com").set("price",11999).set("note", "总而言之这是条测试信息"),
    testBooking2: (new Booking()).set("id", 2).set("reference", "10002").set("status", 1).set("type", 1).set("name", "John").set("phone", 13915063907).set("email", "test@gmail.com").set("price",10000),
    testBooking3: (new Booking()).set("id", 3).set("reference", "10003").set("status", 2).set("type", 1).set("name", "John").set("phone", 13915063907).set("email", "test@gmail.com").set("price",9800),
    testBooking4: (new Booking()).set("id", 4).set("reference", "10004").set("status", 3).set("type", 1).set("name", "John").set("phone", 13915063907).set("email", "test@gmail.com").set("price",4500),
    testBooking5: (new Booking()).set("id", 5).set("reference", "10005").set("status", 4).set("type", 1).set("name", "John").set("phone", 13915063907).set("email", "test@gmail.com").set("price",500),
