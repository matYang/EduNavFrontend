...
testMockObj = {
    ...
    testUser: new User().set('invitationCode','白痴').set('phone','1555****555').set('gender',0),
    ...
    testCourse1: (new Course()).set("categoryValue","000101").set("partnerIntro", longText).set("id", 1).set("marking", '近期门店有优惠活动').set("courseName", "雅思英语").set("price", 10800).set("originalPrice", 12800).set("instName", "南京新东方").set("address", "南京市玄武区玄武区玄武区玄武区持续性武器玄武区").set("cashback", 10).set("commission", 20).set("status",  EnumConfig.CourseStatus.onlined).set("bookingType",  2).set('startUponArrival',1).set('startDate',new Date()).set('quiz','adhj'),
    testCourse2: (new Course()).set("categoryValue","000101").set("partnerIntro", longText).set("id", 2).set("courseName", "SAT").set("price", 10800).set("instName", "School A").set("address", "南京市白下区").set("cashback", 50).set("status",  EnumConfig.CourseStatus.onlined).set('startUponArrival',1).set('startDate',new Date()),
    testCourse3: (new Course()).set("categoryValue","000101").set("partnerIntro", longText).set("id", 3).set("courseName", "托福").set("price", 9800).set("instName", "School B").set("address", "南京市秦淮区").set("cashback", 12).set("status",  EnumConfig.CourseStatus.onlined).set('startUponArrival',0).set('regPhone','随到随学,机构咨询'),
    testCourse4: (new Course()).set("categoryValue","000101").set("id", 4).set("courseName", "GRE").set("price",12900).set("instName", "School C").set("address", "南京市建邺区").set("status",  EnumConfig.CourseStatus.onlined).set('startUponArrival',1).set('startDate',new Date()),
    testCourse5: (new Course()).set("categoryValue","000101").set("id", 5).set("courseName", "四六级").set("price",5800).set("instName", "School D").set("address", "南京市鼓楼区").set("cashback", 10).set("status",  EnumConfig.CourseStatus.onlined).set('startUponArrival',0).set('regPhone','随到随学,机构咨询'),
    ...
    testCourse7: (new Course()).set("categoryValue","000101").set("id", 7).set("courseName", "小学英语补习").set("price",4000).set("instName", "School F").set("address", "南京市浦口区").set("status",  EnumConfig.CourseStatus.onlined).set('startUponArrival',0).set('regPhone','随到随学,机构咨询'),
    ...
    testBooking1: (new Booking()).set("id", 1).set("reference", "10001").set("status", 0).set("type", 1).set("name", "马修").set("phone", 13915063907).set("email", "test@gmail.com").set("price",11999).set("note", "总而言之这是条测试信息").set('actionList',[{name:'onlineCancel'}]).set('type',0).set('status',11),
    testBooking2: (new Booking()).set("id", 2).set("reference", "10002").set("status", 1).set("type", 1).set("name", "John").set("phone", 13915063907).set("email", "test@gmail.com").set("price",10000).set('actionList',[{name:'onlineCancel'},{name:'offlineUserDelay'}]).set('type',0).set('status',11),
    testBooking3: (new Booking()).set("id", 3).set("reference", "10003").set("status", 2).set("type", 1).set("name", "John").set("phone", 13915063907).set("email", "test@gmail.com").set("price",9800).set('actionList',[{name:'onlineCancel'}]),
    testBooking4: (new Booking()).set("id", 4).set("reference", "10004").set("status", 3).set("type", 1).set("name", "John").set("phone", 13915063907).set("email", "test@gmail.com").set("price",4500).set('actionList',[{name:'onlineCancel'}]),
    testBooking5: (new Booking()).set("id", 5).set("reference", "10005").set("status", 4).set("type", 1).set("name", "John").set("phone", 13915063907).set("email", "test@gmail.com").set("price",500).set('actionList',[{name:'onlineCancel'}]),
    testBooking6: (new Booking()).set("id", 6).set("reference", "10006").set("status", 5).set("type", 1).set("name", "John").set("phone", 13915063907).set("email", "test@gmail.com").set("price",7000),
